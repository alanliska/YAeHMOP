...
public class MolCanvas_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toYaehmop = (Button) findViewById(R.id.toYaehmop);
        toYaehmop.setOnClickListener(toYaehmopClick);
...
//                .setView(scrollview)
    ...
    private View.OnClickListener toYaehmopClick; {
        toYaehmopClick = new View.OnClickListener() {
            public void onClick(View v) {
